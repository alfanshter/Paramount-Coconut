<template>
    <main id="main">
        <br /><br />
        <!-- ======= menu-cocopeat Section ======= -->
        <section class="menu-cocopeat">
            <div class="container">
                <div
                    class="section-title"
                    data-aos="fade-up"
                ...
                >
                    <h2>Products</h2>
                    <h3>Our Premium <span>Coco Peat</span></h3>
                </div>
                <div class="row menu-cocopeat-container">
                    <div
                        class="menu-cocopeat-item filter-app"
                        data-aos="zoom-in"
                        data-aos-duration="3000"
                        data-aos-offset="200"
                    >
                        <div class="menu-cocopeat-wrap text-center">
                            <svg
                            ...
                            <h2>Low EC (<1mS/cm)</h2>
                            <div class="menu-cocopeat-info">
                                <div class="menu-cocopeat-links"></div>
                            </div>
                        </div>
                        <div
                            class="paragraf"
        ...
        <section class="menu-cocopeat">
            <div class="container">
                ...
                >
                    <h2>Specification</h2>
                    <h3>Specification <span>Coco Peat</span></h3>
                </div>
                ...
                <div class="row menu-cocopeat-container">
                    ...
                    >
                        <div class="row menu-cocopeat-container">
                            <div
                                class="col-lg-4 col-md-6 menu-cocopeat-item filter-app"
                                data-aos="zoom-in"
                                data-aos-duration="500"
                                data-aos-offset="200"
                            >
                                <div class="menu-cocopeat-wrap text-center">
                                    <img
                                        ...
                                        height="120"
                                    />
                                    <p>Could be used for more than 10 years</p>
                                    <div class="menu-cocopeat-info">
                                        <div class="menu-cocopeat-links"></div>
                                    </div>
                                </div>
                            ...
                            <div
                                class="col-lg-12 col-md-6 menu-cocopeat-item filter-app"
                                data-aos="zoom-in"
                                data-aos-duration="500"
                                data-aos-offset="200"
                            >
                ...
                <ul class="faq-list">
                    ...
                    >
                        ...
                        <div
                            ...
                            data-bs-parent=".faq-list"
                        >
                            <p>We pack and ship it in plastics / blocks</p>
                        </div>
                    </li>
